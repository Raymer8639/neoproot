...
- CI: make basic and advanced smoke-script failures fatal; cover process-vm,
  security/link2symlink, covered-oldroot/procfd, and traced-startup
  regressions in both ARM64 build modes.
