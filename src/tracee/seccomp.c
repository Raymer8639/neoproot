...
static inline void transform_simple_syscall(Tracee* tracee, Sysnum new_sys, word_t arg4, word_t arg5, word_t arg6) {
    set_sysnum(tracee, new_sys);
    ...
    switch (sysnum) {
        ...
        case PR_utimes: {
            ...
            if (tp != 0) {
                ...
                if (read_data(tracee, times, tp, sizeof(times)) < 0) {
        ...
        case PR_utime: {
            ...
            if (buf != 0) {
                ...
                if (read_data(tracee, &times, buf, sizeof(times)) < 0) {
                    set_result_after_seccomp(tracee, -EFAULT);
                    break;
                }
        ...
        case PR_select: {
            ...
            if (timeval_arg != 0) {
                struct timeval tv;
                if (read_data(tracee, &tv, timeval_arg, sizeof(tv)) < 0 || tv.tv_usec >= 1000000 || tv.tv_usec < 0) {
                ...
                if (write_data(tracee, timespec_arg, &ts, sizeof(ts)) < 0) {
                    set_result_after_seccomp(tracee, -EFAULT);
                    break;
                }
            }
