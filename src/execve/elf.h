...
#define ELF_IDENT(header, index) ((header).class64.e_ident[(index)])
#define ELF_CLASS(header) ELF_IDENT(header, 4)
#define IS_CLASS64(header) (ELF_CLASS(header) == 2)

#define ELF_FIELD(header, field) ((header).class64.e_##field)
#define PROGRAM_FIELD(ehdr, phdr, field) ((phdr).class64.p_##field)
#define DYNAMIC_FIELD(ehdr, dynent, field) ((dynent).class64.d_##field)
