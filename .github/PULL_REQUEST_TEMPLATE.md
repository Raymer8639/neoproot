...
State the ARM64 host or Termux environment and the commands run.

## Checklist

- [ ] This PR is focused and based on the current default branch.
- [ ] I tested on a supported ARM64 environment.
